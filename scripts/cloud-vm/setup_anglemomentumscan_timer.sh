...
# strategy_scan.py(20:30 KST=11:30 UTC)보다 5분 뒤인 20:35 KST(11:35 UTC, 예전 16:25 KST)로 잡았다 -
...
ExecStart=/usr/bin/flock $HOME_DIR/.scan_serial.lock $HOME_DIR/venv/bin/python $HOME_DIR/angle_momentum_scan.py
Nice=10
CPUWeight=20
...
[Unit]
Description=Run kiwoom-anglemomentumscan daily at 20:35 KST (11:35 UTC, strategyscan 이후)
