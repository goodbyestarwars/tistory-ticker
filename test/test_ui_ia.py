...
class UiInformationArchitectureTest(unittest.TestCase):
    ...
    def test_home_index_charts_use_live_futures_data_with_sample_toggle_retained(self):
        ...
        self.assertIn("skin-main.js?v=20260923-memo-widget-v2", self.read("skin.html"))
    ...
    def test_global_newspaper_design_system_contract(self):
        ...
        self.assertIn("skin-main.js?v=20260923-memo-widget-v2", skin)
    ...
    def test_stock_search_renders_requested_price_studies_without_resizing_chart(self):
        ...
        self.assertIn("if (!container || !container.querySelectorAll) return;", source)
    ...
    def test_us_stock_detail_uses_site_font_and_consistent_type_scale(self):
        ...
        self.assertIn("function saveStockDrawings", search)
...
"""
    ...
    def test_brand_favicon_wins_over_tistory_injected_icons(self):
        ...
        # 탭 아이콘은 전용 64x64(5.7KB). 네비 배경용을 그대로 쓰면 다 내려올 때까지
        # 브라우저가 옛 아이콘을 띄운다.
        self.assertIn("'favicon.png?v=' + LOGO_VERSION", source)
        # 라이브 skin.html이 가리키는 URL이 내놓는 그림도 현재 로고여야 첫 그림이 옳다.
        # (그 skin.html은 티스토리 관리자에만 있어 참조를 지울 수 없다.)
        self.assertIn("data:image/png;base64,", self.read("img/heart-monitor.svg"))
