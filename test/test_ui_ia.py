...
class UiInformationArchitectureTest(unittest.TestCase):
    ...
    def test_domestic_market_indicators_labels_and_provider_contract(self):
        ...
        self.assertIn("코스피 · 코스닥 현물 (09:00~15:45)", frontend)
        ...
        self.assertIn("domestic-market-indicators.css?v=20260827-dmi-futures-table-v1", frontend)
        self.assertIn("domestic-market-indicators.js?v=20260827-dmi-futures-table-v1", loader)
        ...
        self.assertIn("next >= value ? 'dmi-above' : 'dmi-below'", frontend)
        self.assertIn("border-radius: 4px;", style)
