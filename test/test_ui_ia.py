...
class UiInformationArchitectureTest(unittest.TestCase):
    ...
    def test_home_economic_news_keeps_time_visible_on_mobile(self):
        ...
        style = self.read("style.css")
        shared_timeline = self.read("css/news-timeline.css")
        ...
        self.assertIn(".app-news-event", shared_timeline)
        self.assertIn(".app-news-date", shared_timeline)
    ...
    def test_stock_calendar_supports_searching_loaded_events(self):
        ...
        self.assertIn("stock-calendar.js?v=20260815-company-name", home)
