...
class UiInformationArchitectureTest(unittest.TestCase):
    ...
    def test_domestic_market_indicators_labels_and_provider_contract(self):
        ...
        self.assertIn("domestic-market-indicators.css?v=20260826-dmi-layout-v4", frontend)
        self.assertIn("domestic-market-indicators.js?v=20260826-dmi-layout-v4", loader)
