...
class UiInformationArchitectureTest(unittest.TestCase):
    ...
    def test_domestic_market_indicators_labels_and_provider_contract(self):
        ...
        self.assertIn("증권사에서 돈을 빌려 주식을 매수한 잔액입니다.", frontend)
    ...
    def test_home_economic_news_keeps_time_visible_on_mobile(self):
        ...
        schema = self.read("scripts/cloud-vm/db_schema.py")
        style = self.read("style.css")
        ...
        self.assertIn("v=20260813-breaking-flash-v3", main)
        self.assertIn("data-hen-breaking-form", main)
        self.assertIn("economic-flash", news)
        ...
        self.assertIn("economic_flash_alerts", schema)
    ...
    def test_stock_calendar_supports_searching_loaded_events(self):
        ...
        self.assertIn("stock-calendar.js?v=20260813-persistent-upsert-v2", home)
