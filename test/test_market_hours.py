...
KR_CASH = [
    ...
    ("2026-09-07T20:00", "closed", False),       # 애프터마켓·NXT 동시 종료
...
# 2026-09-07은 미국 노동절이라 세션 케이스를 하루 뒤(9/8 화)로 옮겼다 - 예전 케이스가
# 하필 휴장일을 잡고 있었고, 휴장일 표가 없던 탓에 "정규장"으로 통과하고 있었다.
US = [
    ("2026-09-08T16:59", "closed"),
    ("2026-09-08T17:00", "pre"),                 # EDT 프리마켓 17:00~22:30
    ("2026-09-08T22:30", "regular"),             # EDT 정규장 22:30~05:00
    ("2026-09-09T04:59", "regular"),
    ("2026-09-09T05:00", "after"),               # EDT 애프터 05:00~09:00
    ("2026-09-09T09:00", "closed"),
    # 노동절: 같은 시각이라도 뉴욕 현지 날짜가 휴장일이면 닫혀 있어야 한다.
    ("2026-09-07T22:30", "closed"),
    ("2026-09-08T04:59", "closed"),              # KST로 8일이지만 뉴욕은 아직 7일(노동절)
    ("2026-12-25T23:30", "closed"),              # 성탄절
    ("2026-11-27T23:30", "regular"),             # 조기 마감일도 개장은 한다
    ("2026-11-28T03:01", "after"),               # 13:00 ET 조기 마감 직후
...
HOME = [
    ("2026-09-05T08:30", "us"),                  # 토 오전엔 국내장이 없어 08:00 복귀 대상이 아니다
    ("2026-09-05T08:59", "us"),                  # 토 - 미국 애프터마켓이 09:00에 끝난다
    ("2026-09-05T09:00", "closed"),
    ("2026-09-06T14:00", "closed"),              # 일
    # 2026-09-15: 국내 화면은 NXT 프리마켓(08:00)부터. 09:00이라 08시대에 미국 화면이 떠 있었다.
    ("2026-09-07T07:59", "closed"),              # 월 국내 화면 시작 전
    ("2026-09-07T08:00", "domestic"),
    ("2026-09-08T07:59", "us"),                  # 화
    ("2026-09-08T08:00", "domestic"),
    ("2026-09-08T08:59", "domestic"),
    # 2026-09-14: KRX 애프터마켓(~20:00) 때문에 미국 전환을 프리마켓에서 21:00으로 늦췄다.
    ("2026-09-07T17:00", "domestic"),            # 예전엔 EDT 프리마켓이라 us였다
    ("2026-09-07T20:59", "domestic"),
    ("2026-09-07T21:00", "us"),
    ("2026-01-05T18:00", "domestic"),            # 표준시도 같은 21:00 기준
    ("2026-01-05T21:00", "us"),
