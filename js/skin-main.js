...
(function revealAfterStyles() {
  ...
  var HOME_WEEKLY_REPORT_SCRIPT_URL = 'https://goodbyestarwars.github.io/tistory-ticker/js/home-weekly-report.js?v=20260820-sentiment-color-fix-v1';
    ...
    function dashboardHtml() {
        ...
        + '<svg class="home-closed-lock" width="44" height="52" viewBox="0 0 44 52" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">'
        + '<defs><filter id="hcLockShadow" x="-60%" y="-60%" width="220%" height="220%"><feDropShadow dx="0" dy="3" stdDeviation="3.2" flood-color="#000" flood-opacity="0.35"/></filter></defs>'
        + '<g filter="url(#hcLockShadow)"><path d="M12 22V15a10 10 0 0 1 20 0v7" stroke="currentColor" stroke-width="4.5" stroke-linecap="round"/>'
        + '<rect x="6" y="20" width="32" height="26" rx="6" fill="currentColor"/>'
        + '<circle cx="22" cy="30" r="3.4" fill="#fff"/><path d="M22 32.6V38.5" stroke="#fff" stroke-width="3.2" stroke-linecap="round"/></g>'
        + '</svg><h1>Markets Closed</h1></div><p>토요일·일요일은 국내·미국 증시가 쉽니다.</p></div><div class="home-closed-status"><strong>다음 주 시장을 준비하는 시간입니다.</strong><span>다음 거래일부터 시장 데이터가 업데이트됩니다.</span><small>관심종목 일정과 이전 시장 화면은 위 탭에서 확인할 수 있습니다.</small></div></div>'
        + '</section>'
