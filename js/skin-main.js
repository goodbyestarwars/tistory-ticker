...
document.documentElement.classList.add('skin-ready');
  ...
  (function loadMainNews() {
    ...
    if (!document.querySelector('link[data-main-news-css]')) {
      var link = document.createElement('link');
      link.rel = 'stylesheet';
      link.href = 'https://goodbyestarwars.github.io/tistory-ticker/css/main-news.css?v=20260906-main-news-v8';
    ...
    var script = document.createElement('script');
    script.src = 'https://goodbyestarwars.github.io/tistory-ticker/js/main-news.js?v=20260906-main-news-v8';
    script.defer = true;
