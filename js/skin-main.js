...
(function revealAfterStyles() {
  ...
  (function buildHomeDashboard() {
    ...
    var HOME_WIDGETS_SCRIPT_URL = document.currentScript && document.currentScript.src
      ? document.currentScript.src.replace(/skin-main(?:\.min)?\.js(?:\?.*)?$/, 'home-widgets.js?v=20260819-closed-page-v1')
  ...
  var HOME_WEEKLY_REPORT_SCRIPT_URL = 'https://goodbyestarwars.github.io/tistory-ticker/js/home-weekly-report.js?v=20260819-gold-range-v2';
    ...
    function dashboardHtml() {
        ...
        + '<div class="home-closed-lead"><div class="home-closed-kicker"><span>WEEKEND MARKET NOTE</span><h1>휴장</h1><p>토요일·일요일은 국내·미국 증시가 쉽니다.</p></div><div class="home-closed-status"><strong>다음 주 시장을 준비하는 시간입니다.</strong><span>다음 거래일부터 시장 데이터가 업데이트됩니다.</span><small>관심종목 일정과 이전 시장 화면은 위 탭에서 확인할 수 있습니다.</small></div></div>'
        + '</section>'
