...
document.documentElement.classList.add('skin-ready');
  ...
  (function loadMemoWidget() {
    ...
    link.rel = 'stylesheet';
    link.href = 'https://goodbyestarwars.github.io/tistory-ticker/css/memo-widget.css?v=20260923-memo-widget-v2';
    link.setAttribute('data-memo-widget-css', '1');
    document.head.appendChild(link);
    var script = document.createElement('script');
    script.src = 'https://goodbyestarwars.github.io/tistory-ticker/js/memo-widget.js?v=20260923-memo-widget-v2';
    script.defer = true;
