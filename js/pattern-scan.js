...
(function (global) {
  ...
  var TABS = [
    ...
    { key: 'maCloudBreakout', label: '이평 상승 초입형', desc: '최소 250봉 데이터에서 종가가 224일선 ±3% 이내이고, 종가가 일목 구름 상단을 아직 넘지 않았으며 고가가 구름 상단 3% 이내로 접근했거나 저가가 구름 하단 3% 이내로 접근한 종목입니다(둘 중 하나만 만족해도 포함).' },
