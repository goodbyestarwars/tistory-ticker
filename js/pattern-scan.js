...
(function (global) {
  ...
  var TABS = [
    ...
    { key: 'volumeBreakout', label: '거래량 돌파(5분)', desc: '시가가 전일종가보다 높게(갭상승) 출발하고, 개장 5분 시점(09:05)의 당일 누적 거래량이 전일 하루치의 50% 이상인 종목입니다. 갭상승 없이 거래량만 몰린 종목이나 하락 출발 종목은 빠집니다. 당일 거래량·거래대금·거래증가율 상위 목록을 후보로 쓰므로 순위 밖으로 밀린 종목은 잡히지 않습니다.' }
  ];
  ...
  function scannerInterpretation(item, patternKey) {
    ...
    return {
      ...
      volumeBreakout: '갭상승 출발 + 개장 5분 누적 거래량이 전일의 50% 이상'
