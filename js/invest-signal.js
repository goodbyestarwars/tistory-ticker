...
(function (global) {
  ...
  function buildShell() {
    return ''
      ...
      + '<div class="is-section-desc">'
      + '<div class="is-desc-row"><span class="is-desc-label">종합점수</span>'
      + '<span class="is-desc-chips">'
      + '<span class="is-chip">수급 <b>40%</b></span>'
      + '<span class="is-chip">외국인·기관 <b>25%</b></span>'
      + '<span class="is-chip">기술적 <b>20%</b></span>'
      + '<span class="is-chip">공매도 <b>10%</b></span>'
      + '<span class="is-chip">연기금 <b>5%</b></span>'
      + '</span></div>'
      + '<div class="is-desc-row"><span class="is-desc-label">별점 기준</span>'
      + '<span class="is-desc-chips">'
      + '<span class="is-chip is-chip-buy">🟢 4.5★~ 적극매수</span>'
      + '<span class="is-chip is-chip-buy">🟢 3.8★~ 매수</span>'
      + '<span class="is-chip is-chip-hold">🟡 2.8★~ 보유</span>'
      + '<span class="is-chip is-chip-reduce">🟠 1.8★~ 비중축소</span>'
      + '<span class="is-chip is-chip-sell">🔴 ~1.7★ 매도</span>'
      + '</span></div>'
      + '<div class="is-desc-note">종목분석 페이지의 별점과 같은 계산식입니다.</div>'
      + '</div>'
